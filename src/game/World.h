...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_HARDCORE_MODE,
    CONFIG_UINT32_BOUNTY_ANNOUNCE_MODE,
    CONFIG_UINT32_BOUNTY_ANNOUNCE_COOLDOWN,
    CONFIG_UINT32_BOUNTY_ANNOUNCE_DIGEST_INTERVAL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_RAID_20MAN_HEALTH,
    CONFIG_FLOAT_RATE_RAID_20MAN_DAMAGE,
    CONFIG_FLOAT_RATE_RAID_20MAN_SPELLDAMAGE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_HARDCORE_DEBUFF_LIMIT_REMOVED,
    CONFIG_BOOL_HARDCORE_DISABLE_BATTLEGROUNDS,
    CONFIG_BOOL_HARDCORE_PALADIN_RESTRICTION,
    CONFIG_BOOL_HARDCORE_DEATH_ANNOUNCEMENT,
    CONFIG_BOOL_RAID_20MAN_ENABLE,
    CONFIG_BOOL_RAID_20MAN_PATCH_GATING,
