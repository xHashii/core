...
SET v = (SELECT COUNT(*) FROM `migrations` WHERE `id`='20260921184612');
IF v = 0 THEN
INSERT INTO `migrations` VALUES ('20260921184612');
-- Add your query below.

-- Hardcore & Solo Self-Found (SSF) Guide Creature Template
